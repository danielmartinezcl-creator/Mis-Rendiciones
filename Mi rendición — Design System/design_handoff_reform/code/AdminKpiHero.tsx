 ...
 *     total={16132500}
 *     secondary={[
 *       { label: 'Por aprobar',    value: 4182000, color: 'amber' },
 *       { label: 'Sin reembolsar', value: 2640500, color: 'emerald' },
 *     ]}
 *   />
 *
 * Ejemplo (resumen filtrado de rendiciones):
 *   <AdminKpiHero
 *     title="Resumen filtrado"
 *     total={totalRendido}
 *     secondary={[
 *       { label: 'Total aprobado',    value: totalAprobado,  color: 'teal' },
 *       { label: 'Pendiente reemb.',  value: pendingReimb,   color: 'sky'  },
 *     ]}
 *   />
 *
 * No requiere 'use client' — es un Server Component.
 * Para animar el conteo, envolver en un Client Component con useEffect.
 */
...
/**
 * Formatea un número como monto CLP.
 * Ej: 4182000 → "$ 4.182.000"
 */
