/**
 * Scripts de onboarding para crear organizaciones y seeder de datos iniciales.
 * Ejecutar manualmente: npx ts-node --project tsconfig.json scripts/onboarding.ts
 *
 * ⚠️  NO es un server action — no tiene 'use server'.
 * ⚠️  Requiere SUPABASE_SERVICE_ROLE_KEY en el entorno.
 */
