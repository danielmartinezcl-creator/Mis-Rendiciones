    ...
    <div className="max-w-lg mx-auto space-y-5">
      ...
      <form onSubmit={handleSave} className="space-y-4">
        ...
        <div className="bg-white rounded-card shadow-[0_1px_4px_rgba(0,0,0,.08)] p-5 space-y-4">
          ...
          <div>
            <label className="block card-label font-medium text-ink-600 mb-1">Nombre completo</label>
            <input
              type="text"
              value={fullName}
          ...
          <div>
            <label className="block card-label font-medium text-ink-600 mb-1">RUT</label>
            <input
              type="text"
              value={rut}
          ...
          <div>
            <label className="block card-label font-medium text-ink-600 mb-1">Correo electrónico</label>
            <input
              type="email"
              value={profile.email}
              disabled
              className="w-full border border-ink-100 rounded-item px-3 py-2.5 text-[16px] bg-ink-50 text-ink-400 cursor-not-allowed"
            />
            <p className="card-meta text-ink-400 mt-1">El correo se gestiona desde la cuenta de acceso</p>
          </div>

          <div>
            <label className="block card-label font-medium text-ink-600 mb-1">Departamento</label>
            <input
              type="text"
              value={department}
        ...
        <div className="bg-white rounded-card shadow-[0_1px_4px_rgba(0,0,0,.08)] p-5 space-y-4">
          ...
          <p className="card-meta text-ink-400 -mt-2">Usada por el administrador para procesar reembolsos</p>

          <div>
            <label className="block card-label font-medium text-ink-600 mb-1">Institución bancaria</label>
            <select
              value={bankName}
          ...
          <div>
            <label className="block card-label font-medium text-ink-600 mb-1">Tipo de cuenta</label>
            <select
          ...
          <div>
            <label className="block card-label font-medium text-ink-600 mb-1">Número de cuenta</label>
            <input
              type="text"
              value={bankAccount}
